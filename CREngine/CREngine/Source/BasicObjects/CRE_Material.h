...
class CRE_Material : public CRE_ManagedObject
{
	DEF_CLASS(CRE_Material, CRE_ManagedObject);

	virtual ~CRE_Material();
	...
	CRE_Loadable<CRE_Shader> VertexShader;
	CRE_Loadable<CRE_Shader> FragmentShader;
