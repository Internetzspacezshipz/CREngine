...
//UI
#include "UserInterface/CrUI_MenuBar.hpp"
...
void CrApp::SetupGlobalVariables(VulkanEngine* InEnginePointer)
{
    CrGlobals::GetEnginePointer() = InEnginePointer;
    CrGlobals::GetKeySystemPointer() = &InEnginePointer->_KeySystem;
    CrGlobals::GetAppPointer() = this;
