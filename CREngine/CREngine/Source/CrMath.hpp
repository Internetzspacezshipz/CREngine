...
struct CrVertex
{
	...
	static std::vector<VkVertexInputAttributeDescription> GetAttributeDescriptions()
	{
		...
		AttributesDescriptions[0].offset = offsetof(CrVertex, Position);
		...
		AttributesDescriptions[1].offset = offsetof(CrVertex, Color);
	...
	static std::vector<VkVertexInputBindingDescription> GetBindingDescriptions()
	{
		...
		BindingDescriptions[0].stride = sizeof(CrVertex);
