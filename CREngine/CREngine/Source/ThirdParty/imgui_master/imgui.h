...
struct ImFontGlyph
{
    ...
    float           U0, V0, U1, V1;     // TextureData coordinates
};
...
// LoadTexture and rasterize multiple TTF/OTF fonts into a same texture. The font atlas will build a single texture holding:
//  - One or more fonts.
...
struct ImFontAtlas
{
    ...
    int                         TexDesiredWidth;    // TextureData width desired by user before Build(). Must be a power-of-two. If have many glyphs your graphics API have texture size restrictions you may want to increase texture width to decrease height.
    ...
    int                         TexWidth;           // TextureData width calculated during Build().
    int                         TexHeight;          // TextureData height calculated during Build().
    ImVec2                      TexUvScale;         // = (1.0f/TexWidth, 1.0f/TexHeight)
    ImVec2                      TexUvWhitePixel;    // TextureData coordinates to a white pixel
